...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Dhruv Sharma" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Dhruv Sharma — Portfolio" },
      { name: "twitter:card", content: "summary_large_image" },
      { title: "DhruvCyberDen" },
      { property: "og:title", content: "DhruvCyberDen" },
      { name: "twitter:title", content: "DhruvCyberDen" },
